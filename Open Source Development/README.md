...
<table width="100%">
  ...
  <tr>
    <td><a href="https://www.bitbucket.org">Bitbucket</a></td>
    <td>Bitbucket is a cloud-based Git-based service that allows developers to store, manage, and track code changes. It's designed for professional teams, providing a central place to collaborate on source code, plan projects, and test and deploy code.</td>
  </tr>
</table>
