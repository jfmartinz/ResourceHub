          ...
          extensionlessFiles.forEach((file) => {
            ...
            fetch(
              ...
              .then((readmeData) => {
                ...
                <p class="font-semibold z-10 text-center hover:text-black text-xs sm:text-xs md:text-xl lg:text-xl xl:text-2xl 2xl:text-3xl text-neutral-300">${file.name}</p>
