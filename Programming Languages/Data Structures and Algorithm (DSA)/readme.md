...
<table width="100%" id="data-structures-and-algorithm">
  ...
  <tr>
  <td><a href="https://youtube.com/playlist?list=PLEJXowNB4kPwTb4BivkY0dENHmXdOEM3V&si=DiPfbRvuhacO00UA"> Searching Algorithms </a></td>
  <td> Searching algorithms are used to find a specific element in an array, string, linked list, or some other data structure. </td>
  </tr>
  <tr>
  <td><a href="https://youtube.com/playlist?list=PLEJXowNB4kPxse7iinEzb6FivjtQVxOXI&si=sfW3dRl3QQ8Veluq"> Sorting Algorithms </a></td>
  <td> Sorting algorithms are used to sort a list of elements in a particular order. </td>
  </tr>
  </table>
